...
import com.harvard.calm.domain.Referal;
import com.harvard.calm.repository.ReferalRepository;
...
/**
 * REST controller for managing {@link com.harvard.calm.domain.Referal}.
 */
@RestController
@RequestMapping("/api")
@Transactional
