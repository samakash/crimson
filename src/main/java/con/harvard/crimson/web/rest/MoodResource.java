...
import con.harvard.crimson.domain.Mood;
import con.harvard.crimson.repository.MoodRepository;
...
/**
 * REST controller for managing {@link con.harvard.crimson.domain.Mood}.
 */
@RestController
@RequestMapping("/api")
@Transactional
