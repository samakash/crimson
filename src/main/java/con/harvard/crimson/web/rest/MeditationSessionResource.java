...
import con.harvard.crimson.domain.MeditationSession;
import con.harvard.crimson.repository.MeditationSessionRepository;
...
/**
 * REST controller for managing {@link con.harvard.crimson.domain.MeditationSession}.
 */
@RestController
@RequestMapping("/api")
@Transactional
