...
import con.harvard.crimson.domain.Referal;
import con.harvard.crimson.repository.ReferalRepository;
...
/**
 * REST controller for managing {@link con.harvard.crimson.domain.Referal}.
 */
@RestController
@RequestMapping("/api")
@Transactional
