package con.harvard.crimson.web.rest;
...
import con.harvard.crimson.IntegrationTest;
import con.harvard.crimson.domain.Contact;
import con.harvard.crimson.repository.ContactRepository;
...
class ContactResourceIT {
    ...
    public static Contact createEntity(EntityManager em) {
        Contact contact = new Contact().info(DEFAULT_INFO).content(DEFAULT_CONTENT);
        return contact;
    }
    ...
    public static Contact createUpdatedEntity(EntityManager em) {
        Contact contact = new Contact().info(UPDATED_INFO).content(UPDATED_CONTENT);
        return contact;
    }
    ...
    void createContact() throws Exception {
        ...
        assertThat(testContact.getInfo()).isEqualTo(DEFAULT_INFO);
        assertThat(testContact.getContent()).isEqualTo(DEFAULT_CONTENT);
    }
    ...
    void putExistingContact() throws Exception {
        ...
        updatedContact.info(UPDATED_INFO).content(UPDATED_CONTENT);
        ...
        Contact testContact = contactList.get(contactList.size() - 1);
        assertThat(testContact.getInfo()).isEqualTo(UPDATED_INFO);
        assertThat(testContact.getContent()).isEqualTo(UPDATED_CONTENT);
    }
    ...
    void partialUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.info(UPDATED_INFO);
    ...
    void fullUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.info(UPDATED_INFO).content(UPDATED_CONTENT);
