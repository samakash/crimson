...
import con.harvard.crimson.domain.Event;
import con.harvard.crimson.repository.EventRepository;
...
class EventResourceIT {
    ...
    public static Event createEntity(EntityManager em) {
        Event event = new Event().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).date(DEFAULT_DATE).location(DEFAULT_LOCATION);
        return event;
    }
    ...
    public static Event createUpdatedEntity(EntityManager em) {
        Event event = new Event().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).date(UPDATED_DATE).location(UPDATED_LOCATION);
        return event;
    }
    ...
    void putExistingEvent() throws Exception {
        ...
        updatedEvent.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).date(UPDATED_DATE).location(UPDATED_LOCATION);
    ...
    void fullUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).date(UPDATED_DATE).location(UPDATED_LOCATION);
